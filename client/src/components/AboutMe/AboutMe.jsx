        ...
        <div className={styles.contentContainer}>
          ...
          <div className={styles.content}>
            <section className={`${styles.leftColumn} ${styles.Linea}`}>
              <div className={styles.stat}>
                ...
                <h3 className={styles.statTitle}>
                  <span className={styles.highlight}>5 Years</span> Job Experience
                </h3>
              </div>
              <div className={styles.stat}>
                <img src="/img/icon/projects-icon.svg" alt="Projects icon" className={styles.icon} />
                <h3 className={styles.statTitle}>
                  <span className={styles.highlight}>6+ Projects</span> Completed
                </h3>
              </div>
            </section>
            <section className={styles.rightColumn}>
              ...
              <p className={styles.paragraph}>
                As a full stack developer, I am proficient in a variety of programming languages and frameworks, including HTML, CSS, JavaScript. I have experience working with popular technologies such as MongoDB, Express, React, and Node.js, i have the ability to quickly adapt to new technologies and frameworks. I have a wide range of knowledge about technologies beyond those mentioned.
              </p>
              <p className={styles.paragraph}>
